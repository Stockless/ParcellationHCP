...
def recalc_probability(anatomic_parcel):
    # print("Recalculating probabilities for ",anatomic_parcel.label)
    for sub_parcel in anatomic_parcel.sub_parcels:
        # print("Recalculating probabilities for sp: ",sub_parcel.label)
        for tri in sub_parcel.triangles:
