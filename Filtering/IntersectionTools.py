...
def intersection (start, end, folder_path, bundles_path, I_flag, M_flag, R_flag, theta):
    ...
    for i in range(start,end+1):     #Iteración sobre todos los sujetos   
        ...
        intersection_path =bundles_path + 'intersection/'+ intersection + sub + '/'
        membership_path= bundles_path + 'intersection/'+ membership + sub + '/'
        ...
        individual_path = bundles_path + 'inter-clustered_QB_' + str(theta)+'/' + sub + '/individual_clusters_aligned/T1/' 
        ...
        if R_flag==0:
            ...
            #---------- Llamada a código C++ ----------#
            print('\nLhemi direct')
            sp.call(['intersection/./interx', Lhemi_path, '', individual_path, '', intersection_path + 'L-L_direct/', '', 
            ...
            #---------- Llamada a código C++ ----------#
            print('\nLhemi inverse')
            sp.call(['intersection/./interx', Lhemi_path, '', individual_path, '', intersection_path + 'L-L_inverse/', '', 
